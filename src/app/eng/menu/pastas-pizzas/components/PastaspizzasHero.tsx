  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image 
          src="/pasta-pizza.jpg" 
          alt="Artisanal pizzas and pasta" 
          fill 
          priority 
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Pizzas & <br/><span className="italic text-amber-200">Artisanal Pasta</span>
          </motion.h1>
          ...
          >
            Our Italian specialties prepared with fresh ingredients and a creative touch.
          </motion.p>
