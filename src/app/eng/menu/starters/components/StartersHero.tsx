  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image 
          src="/starters.jpg" 
          alt="Fresh and delicious starters" 
          fill 
          priority 
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Our delicious <br/><span className="italic text-amber-200">starters</span>
          </motion.h1>
          ...
          >
            Discover our selection of fresh and flavorful starters, prepared with quality ingredients.
          </motion.p>
