    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            The Art of <br/><span className="italic text-amber-200">Tasting</span>
          </motion.h1>
          ...
          >
            Immerse yourself in a sensory journey where every cocktail tells a story through rare ingredients and ancestral techniques.
          </motion.p>
