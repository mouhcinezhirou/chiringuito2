...
const DessertsHero = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* Background Image - replace with your desserts image */}
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Sweet Treats <br/><span className="italic text-amber-200">& Desserts</span>
          </motion.h1>
          ...
          >
            End your meal on a high note with our homemade desserts crafted with passion.
          </motion.p>
