    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Wines & <br/><span className="italic text-amber-200">Champagnes</span>
          </motion.h1>
          ...
          >
            Explore our curated selection of Moroccan and international wines, along with prestigious champagnes to enhance your dining experience.
          </motion.p>
