  ...
  const menuSections: MenuSection[] = [
    {
      ...
      items: [
        { name: 'Martini Prosecco', glassPrice: 120, bottlePrice: 1200 },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Brouilly Les Jarrons Thorins', bottlePrice: 560 },
