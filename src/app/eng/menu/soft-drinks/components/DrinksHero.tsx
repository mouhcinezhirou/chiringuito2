    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            The Refreshing <br/><span className="italic text-amber-200">Spirit</span>
          </motion.h1>
          ...
          >
            Discover our selection of premium drinks, fresh juices, and artisanal refreshments designed to quench your thirst.
          </motion.p>
