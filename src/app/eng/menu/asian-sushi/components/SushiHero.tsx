    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Discover <br/><span className="italic text-amber-200">our sushi</span>
          </motion.h1>
          ...
          >
            A selection of fresh sushi prepared with premium ingredients and a touch of creativity.
          </motion.p>
