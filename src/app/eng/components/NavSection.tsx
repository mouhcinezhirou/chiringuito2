...
const menuCategories: MenuCategory[] = [
  {
    ...
    link: "/menu/cocktails",
    icon: <Wine size={18} />,
    description: "Handcrafted drinks made with premium spirits"
  },
  {
  ...
  },
  {
    ...
    icon: <Beer size={18} />,
    description: "Craft and imported beers from around the world"
  },
  {
    category: "Asian Cuisine / Sushi",
    link: "/eng/menu/asian-sushi",
    icon: <Utensils size={18} />,
    description: "Traditional and contemporary oriental delights"
  },
  {
    category: "Starters",
    link: "/eng/menu/starters",
    icon: <Salad size={18} />,
    description: "Small plates to start your culinary journey"
  },
  {
    category: "Fish & Meat",
    link: "/eng/menu/fish-and-meat",
    icon: <Fish size={18} />,
    description: "Premium seafood and prime cuts prepared to perfection"
  },
  {
  ...
  },
  {
    ...
    icon: <Cake size={18} />,
    description: "Sweet finales to complete your gastronomic experience"
  }
];
    ...
    <div className="py-20 px-4 bg-gradient-to-b from-neutral-50 to-neutral-100">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          >
            {selectedCategory 
              ? `A refined selection of ${selectedCategory ? selectedCategory.toLowerCase() : ''} prepared with mastery` 
              : 'Browse our carefully selected culinary creations'}
          </motion.p>
          <motion.div
            initial={{ width: 0 }}
            whileInView={{ width: '100px' }}
