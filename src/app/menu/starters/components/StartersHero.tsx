...
const StartersHero = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* Background Image - replace with your starters image */}
      <div className="absolute inset-0 z-0">
        <Image 
          src="/starters.jpg" 
          alt="Entrées fraîches et délicieuses" 
          fill 
          priority 
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Nos délicieuses <br/><span className="italic text-amber-200">entrées</span>
          </motion.h1>
          ...
          >
            Découvrez notre sélection d'entrées fraîches et savoureuses, préparées avec des ingrédients de qualité.
          </motion.p>
