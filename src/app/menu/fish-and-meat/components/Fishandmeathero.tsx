...
const FishMeatHero = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* Background Image - replace with your fish/meat image */}
      <div className="absolute inset-0 z-0">
        <Image 
          src="/fish-meat.jpg" 
          alt="Poissons et viandes de qualité" 
          fill 
          priority 
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Nos délices <br/><span className="italic text-amber-200">de la mer & terre</span>
          </motion.h1>
          ...
          >
            Découvrez nos poissons frais et viandes de qualité, préparés avec savoir-faire et passion.
          </motion.p>
