    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            El Arte de la <br/><span className="italic text-amber-200">Degustación</span>
          </motion.h1>
          ...
          >
            Sumérgete en un viaje sensorial donde cada cóctel cuenta una historia a través de ingredientes raros y técnicas ancestrales.
          </motion.p>
