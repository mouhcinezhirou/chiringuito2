...
const PizzaPastaHero = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('pizza-pasta-menu-section');
    if (menuSection) {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* Imagen de fondo - reemplaza con tu imagen de pizza/pasta */}
      <div className="absolute inset-0 z-0">
        <Image 
          src="/pasta-pizza.jpg" 
          alt="Pizzas y pastas artesanales" 
          fill 
          priority 
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Pizzas & <br/><span className="italic text-amber-200">Pastas artesanales</span>
          </motion.h1>
          ...
          >
            Nuestras especialidades italianas preparadas con ingredientes frescos y un toque creativo.
          </motion.p>
