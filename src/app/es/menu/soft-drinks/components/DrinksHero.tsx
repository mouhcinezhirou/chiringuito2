    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            El Espíritu <br/><span className="italic text-amber-200">Refrescante</span>
          </motion.h1>
          ...
          >
            Descubre nuestra selección de bebidas premium, jugos frescos y refrescos artesanales diseñados para refrescarte.
          </motion.p>
