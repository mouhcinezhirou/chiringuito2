...
const DessertsHero = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('desserts-menu-section');
    if (menuSection) {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* Imagen de fondo - reemplaza con tu imagen de postres */}
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Dulzuras <br/><span className="italic text-amber-200">& postres</span>
          </motion.h1>
          ...
          >
            Termina tu comida con broche de oro con nuestros postres caseros preparados con pasión.
          </motion.p>
