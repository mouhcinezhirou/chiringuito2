...
const FishMeatHero = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('fish-meat-menu-section');
    if (menuSection) {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* Imagen de fondo - reemplazar con tu imagen de pescados/carnes */}
      <div className="absolute inset-0 z-0">
        <Image 
          src="/fish-meat.jpg" 
          alt="Pescados y carnes de calidad" 
          fill 
          priority 
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Nuestros manjares <br/><span className="italic text-amber-200">del mar y la tierra</span>
          </motion.h1>
          ...
          >
            Descubre nuestros pescados frescos y carnes de calidad, preparados con maestría y pasión.
          </motion.p>
