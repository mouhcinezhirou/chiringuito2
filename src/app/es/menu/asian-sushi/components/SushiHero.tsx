  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image 
          src="/sushi.jpg"  // Reemplaza con la ruta de tu imagen de sushi
          alt="Sushi fresco y delicioso" 
          fill 
          priority 
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Descubre <br/><span className="italic text-amber-200">nuestros sushis</span>
          </motion.h1>
          ...
          >
            Una selección de sushis frescos preparados con ingredientes premium y un toque de creatividad.
          </motion.p>
