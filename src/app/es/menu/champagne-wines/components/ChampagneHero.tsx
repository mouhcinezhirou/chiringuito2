    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-start h-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          >
            Vinos & <br/><span className="italic text-amber-200">Champagnes</span>
          </motion.h1>
          ...
          >
            Descubre nuestra selección curada de vinos marroquíes e internacionales, junto con champagnes de prestigio para elevar tu experiencia gastronómica.
          </motion.p>
